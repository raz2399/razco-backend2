...
app.get('/api/raffles',(req,res)=>res.json({success:true,raffles:[]}));
app.post('/api/ai/write',(req,res)=>res.json({success:true,message:'AI writer coming soon.'}));
app.post('/api/flash',(req,res)=>res.json({success:true,sent:0}));
app.post('/api/mystery',(req,res)=>res.json({success:true}));
